      ...
      <div className="container">
        <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-6'>
              <input type="text" placeholder="Search" className='hidden sm:block py-2 px-3 
              round-full bg-slate-200'/>
              <div className='bg-primary hover:bg-primary/80 p-3 rounded-full cursor-pointer'>
                <FaSearch className='text-white text-sm'/>
              </div>
              <div className='flex items-center center navlink cursor-pointer'>
                Eng
                <span>
